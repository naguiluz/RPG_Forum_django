...
This template contains a project, `RPG_Forum_django`, and an app, `api`,
...
1. Replace all instances of `RPG_Forum_django` with your application name. **This includes the folder included in this repository.**
...
This template includes a project `RPG_Forum_django` which should be renamed
...
all instances of `RPG_Forum_django` with your app's name.
